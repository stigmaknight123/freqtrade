...
# Sortino settings
TARGET_TRADES = 300 #2000
EXPECTED_MAX_PROFIT = TARGET_TRADES*0.1 #3
MAX_ACCEPTED_TRADE_DURATION = 180 #420
MIN_ACCEPTED_TRADE_DURATION = 2

# Loss settings
# EXPECTED_MAX_PROFIT = 14.0 #3
WIN_LOSS_WEIGHT = 20
AVERAGE_PROFIT_WEIGHT = 20
AVERAGE_PROFIT_THRESHOLD = 0.1 # 2%
SORTINO_WEIGHT = 0.02
TOTAL_PROFIT_WEIGHT = 5
DRAWDOWN_WEIGHT = 10
DURATION_WEIGHT = 2
...
class GeniusAvgWinLoss(IHyperOptLoss):
    """
