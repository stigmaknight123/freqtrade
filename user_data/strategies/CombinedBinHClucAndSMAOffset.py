...
class CombinedBinHClucAndSMAOffset(IStrategy):
    INTERFACE_VERSION = 2
    ...
    buy_rsi_diff = DecimalParameter(34.0, 60.0, default=50.48,
                                    space='buy', decimals=2, optimize=True, load=True)
    ...
    buy_volume_1 = DecimalParameter(1.0, 10.0, default=2.0, space='buy',
    ...
    sell_custom_roi_profit_3 = DecimalParameter(
        0.015, 0.30, default=0.08, space='sell', decimals=2, optimize=False, load=True)
    ...
    sell_custom_roi_profit_4 = DecimalParameter(
        0.03, 0.5, default=0.14, space='sell', decimals=2, optimize=False, load=True)
    ...
    sell_custom_stoploss_1 = DecimalParameter(-0.15, -0.03, default=-
                                              0.05, space='sell', decimals=2, optimize=False, load=True)
    ...
    rsi_buy = IntParameter(30, 70, default=35, space='buy', optimize=False, load=True)
    ...
    def informative_1h_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        # Check trend
        informative_1h['bull_100'] = informative_1h['ema_100'].gt(
            informative_1h['ema_100'].shift(10))
