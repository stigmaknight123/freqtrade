...
class NostalgiaForInfinityV3(IStrategy):
    ...
    def custom_sell(self, pair: str, trade: 'Trade', current_time: 'datetime', current_rate: float,
        ...
        if (last_candle is not None):
            ...
            elif (current_profit > self.sell_trail_profit_min_1.value) & (current_profit < self.sell_trail_profit_max_1.value) & (((trade.max_rate - trade.open_rate) / trade.open_rate) > (current_profit + self.sell_trail_down_1.value)):
