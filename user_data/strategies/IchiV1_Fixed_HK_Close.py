...
def ichimoku_edit(
    dataframe, conversion_line_period=9, base_line_periods=26, laggin_span=52, displacement=26, open="open", high="high", low="low", close="close"
):
    """
...
class IchiV1_Fixed_HK_Close(IStrategy):
    ...
    def populate_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe['hk_open'] = heikinashi['open']
        dataframe['hk_close'] = heikinashi['close']
        dataframe['hk_high'] = heikinashi['high']
        dataframe['hk_low'] = heikinashi['low']

        dataframe['trend_close_5m'] = dataframe['hk_close']
        dataframe['trend_close_15m'] = ta.EMA(dataframe['hk_close'], timeperiod=3)
        dataframe['trend_close_30m'] = ta.EMA(dataframe['hk_close'], timeperiod=6)
        dataframe['trend_close_1h'] = ta.EMA(dataframe['hk_close'], timeperiod=12)
        dataframe['trend_close_2h'] = ta.EMA(dataframe['hk_close'], timeperiod=24)
        dataframe['trend_close_4h'] = ta.EMA(dataframe['hk_close'], timeperiod=48)
        dataframe['trend_close_6h'] = ta.EMA(dataframe['hk_close'], timeperiod=72)
        dataframe['trend_close_8h'] = ta.EMA(dataframe['hk_close'], timeperiod=96)

        dataframe['trend_open_5m'] = dataframe['hk_open']
        dataframe['trend_open_15m'] = ta.EMA(dataframe['hk_open'], timeperiod=3)
        dataframe['trend_open_30m'] = ta.EMA(dataframe['hk_open'], timeperiod=6)
        dataframe['trend_open_1h'] = ta.EMA(dataframe['hk_open'], timeperiod=12)
        dataframe['trend_open_2h'] = ta.EMA(dataframe['hk_open'], timeperiod=24)
        dataframe['trend_open_4h'] = ta.EMA(dataframe['hk_open'], timeperiod=48)
        dataframe['trend_open_6h'] = ta.EMA(dataframe['hk_open'], timeperiod=72)
        dataframe['trend_open_8h'] = ta.EMA(dataframe['hk_open'], timeperiod=96)

        dataframe['fan_magnitude'] = (dataframe['trend_close_1h'] / dataframe['trend_close_8h'])
        dataframe['fan_magnitude_gain'] = dataframe['fan_magnitude'] / dataframe['fan_magnitude'].shift(1)

        ichimoku = ichimoku_edit(dataframe, conversion_line_period=20, base_line_periods=60, laggin_span=120, displacement=30, open="hk_open", high="hk_high", low="hk_low", close="hk_close")
