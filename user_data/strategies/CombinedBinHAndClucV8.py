...
class CombinedBinHAndClucV8(IStrategy):
    ...
    sell_custom_roi_profit_3 = DecimalParameter(0.015, 0.30, default=0.08, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_roi_rsi_3 = DecimalParameter(44.0, 58.0, default=56, space='sell', decimals=2, optimize=False, load=True)
    sell_custom_roi_profit_4 = DecimalParameter(0.03, 0.5, default=0.14, space='sell', decimals=2, optimize=False, load=True)
